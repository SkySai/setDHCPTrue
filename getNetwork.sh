...
#curl -H "Authorization: LSBasic ${b64auth}" -H "Content-Type: application/json" -d "{"call":"SysAdmin_getNetworkConfig","params":{}}" http://${ip}/rest/request/${session} 
...
#curl -H "Authorization: LSBasic ${b64auth}" -H "Content-Type: application/json" -d "{\"params\":{},\"call\":\"SysAdmin_getNetworkConfig\"}" http://${ip}/rest/request/${session} 
curl -H "Authorization: LSBasic ${b64auth}" -H "Content-Type: application/json" -d "{\"params\":{},\"call\":\"SysAdmin_getNetworkConfig\"}" http://${ip}/rest/request/${session} > tempNetwork.txt
